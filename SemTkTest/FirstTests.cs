...
namespace SemTkTest
{
    ...
    public class FirstTests
    {
        ...
        {
            NodeGroupExecutionClientConfig necc = new NodeGroupExecutionClientConfig("http", "vesuvius37.crd.ge.com", 12058);
            NodeGroupExecutionClient nec = new NodeGroupExecutionClient(necc);

            String nodeGroupId = "Logging SPARQLgraph alerts";
            String connectionInfo = "{ \"name\": \"Logging SparqlGraph\", \"domain\": \"http://com.ge.research/knowledge/UsageLogging\", \"model\": [ { \"type\": \"virtuoso\", \"url\": \"http://vesuvius37.crd.ge.com:2420\", \"dataset\": \"http://com.ge.research/knowledge/UsageLogging/LogMaster\"} ], \"data\": [ {\"type\": \"virtuoso\", \"url\": \"http://vesuvius37.crd.ge.com:2420\", \"dataset\": \"http://com.ge.research/knowledge/UsageLogging/SPARQLGraph\" } ]}";
